  ...
  <pipe>
    ...
    <rasterrenderer type="singlebandpseudocolor" opacity="1" band="1" nodataColor="" alphaBand="-1" classificationMin="0" classificationMax="65">
      ...
      <rastershader>
        ...
        <item value="0" label="0° (Flat - Unsuitable)" color="#1a9641" alpha="255"/>
        <item value="15" label="15° (Min - Marginal)" color="#a6d96a" alpha="255"/>
        <item value="20" label="20° (Good)" color="#ffffbf" alpha="255"/>
        <item value="25" label="25° (Optimal)" color="#fdae61" alpha="255"/>
        <item value="30" label="30° (Good)" color="#f46d43" alpha="255"/>
        <item value="40" label="40° (Max - Marginal)" color="#d73027" alpha="255"/>
        <item value="65" label="65° (Too Steep)" color="#a50026" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
