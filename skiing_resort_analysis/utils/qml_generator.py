...
'''
    ...
    print(f"✓ QML style saved: {output_path}")
...
def create_slope_qml(output_path, min_val=0, max_val=65):
    ...
    color_ramp = [
        (0, 26, 150, 65, 255, "0° (Flat - Unsuitable)"),
        (15, 166, 217, 106, 255, "15° (Min - Marginal)"),
        (20, 255, 255, 191, 255, "20° (Good)"),
        (25, 253, 174, 97, 255, "25° (Optimal)"),
        (30, 244, 109, 67, 255, "30° (Good)"),
        (40, 215, 48, 39, 255, "40° (Max - Marginal)"),
        (max_val, 165, 0, 38, 255, f"{max_val:.0f}° (Too Steep)"),
    ]
